package com.codecafe.datastructures.linkedlist;
...
public class LinkedList {
	...
	public static LinkedList insertAtPosition(LinkedList list, String data, int index) {
		...
		if(list.head == null) {
			...
			while(currentNode != null) {
				...
				if(counter == index) {
					// Since the currentNode is the required position, unlink currentNode from the linked list
					prev.next = newNode; 
	...
	public static LinkedList deleteByPosition(LinkedList list, int index) {
		...
		// Case 2 : If the index is greater than 0 but less then the size of the linked list
		int counter = 0;
	...
	public static void main(String[] args) {
		...
		insertAtPosition(list, "Abhinav", 10);
		printList(list);
	}
